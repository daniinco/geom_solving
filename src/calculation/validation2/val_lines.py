...
1. Перечисли все точки, которые явно лежат на одной прямой согласно условию (на сторонах, середины, пересечения, на продолжениях)
2. Проверь каждую тройку: ровно 3 буквы? Порядок правильный?
3. Нет ли лишних троек (точки не на одной прямой)?
4. Не пропущены ли тройки (середины, пересечения, точки на сторонах)?
...
Найди тройки точек на одной прямой правильно. Сразу напиши условия строго по формату (напиши "Условия: " и сразу условия). Если троек нет — выведи только: -. Не рассуждай."""
